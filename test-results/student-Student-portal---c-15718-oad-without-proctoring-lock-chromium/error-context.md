...
- Name: student.spec.js >> Student portal - complete functional flow >> file-based practical can accept a student upload without proctoring lock
- Location: tests\student.spec.js:193:3
