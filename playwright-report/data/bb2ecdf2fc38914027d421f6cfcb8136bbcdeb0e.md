...
- Name: student.spec.js >> Student portal - complete functional flow >> assigned test has correct opening state and can be opened
- Location: tests\student.spec.js:38:3
