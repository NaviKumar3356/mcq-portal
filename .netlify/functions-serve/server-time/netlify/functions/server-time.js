...
var require_auth = __commonJS({
  "netlify/functions/utils/auth.js"(exports2, module2) {
    ...
    module2.exports = { sign, verify, getAuth, json: json2, requireRole };
  }
});

// netlify/functions/server-time.js
var { json } = require_auth();
exports.handler = async () => {
  return json(200, { now: (/* @__PURE__ */ new Date()).toISOString() });
};
